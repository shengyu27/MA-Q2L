...
import lib.models
from lib.models.hiera import hiera
...
def get_model_path(modelname):
    ...
    pretrained_dir = '/home/ubuntu/sy/query2labels-main-use-this/pretrained'
    PTDICT = {
        'CvT_w24': 'CvT_w24-40epochs-mIoU46.tar',#'CvT-w24-384x384-IN-22k.pth',
        'CvT_21_384':'CvT_w24-40epochs-mIoU46.tar',
        'CvT_21_224': 'CvT_w24-40epochs-mIoU46.tar',
        'swin_L_384_22k': 'swin_large_patch4_window12_384_22k.pkl',
        'tresnetl': 'tresnetl_448.pkl',#tresnet_l_448.pth',
...
def build_backbone(args):
    ...
    if args.backbone in ['swin_B_224_22k', 'swin_B_384_22k', 'swin_L_224_22k', 'swin_L_384_22k']:
        ...
        del backbone.head
    elif args.backbone in ['CvT_w24','CvT_21_384','CvT_21_224']:
        # CvT_w24: use 224*224 instead of 384*384 because it will out of mereory
        ...
        del backbone.head
    elif args.backbone in ['hiera_L']:
        position_embedding = build_position_encoding(args)
        backbone = hiera.hiera_large_224()
        bb_num_channels = 1152
