...
class MAQ2L(nn.Module):
    ...
    def forward(self, input):
        ...
        # if backbone is hiera use this
        # src = src.view(src.shape[0], src.shape[2], 7, 7)
        query_input = self.query_embed.weight
        # query_input : [17,2048]


        hs, _ = self.transformer(self.input_proj(src), query_input, pos)  # B,K,d
